...
var fixedTop = (AllHet - mainHet)/2
 ...
 var swiperFooter = new Swiper('.swiper-container-footer', {
 		pagination: '.swiper-pagination-footer',
 ...
 $(".swiper-container-footer").mouseenter(function(){
      console.log("footer")
        swiperFooter.stopAutoplay()
    }).mouseleave(function() {
        swiperFooter.startAutoplay();
    });
    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.605389,31.218528);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"上海博达数据有限公司",content:"地址：上海浦东张江高科居里路123号<br>电话：021-50800666",point:"121.603444|31.217926",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
